---
title: Microbiota analysis complements fecal immunochemical test for detection of colonic lesions #must be 90 characters or less  (including spaces)
csl: nature.csl
output:
  word_document:
...
legend('bottomright', legend=c(sprintf('RF-Les. vs Norm.: %.3g',les_roc$auc),
                               sprintf('FIT-Les. vs Norm.: %.3g',les_fit_roc$auc),
                               sprintf('RF-Canc. vs Norm: %.3g',canc_roc$auc),
                               sprintf('FIT-Canc. vs Norm.: %.3g',canc_fit_roc$auc),
                               sprintf('RF-Ade. vs Norm.: %.3g',ade_roc$auc),
...
**Extended Data Figure 4.** ROC curves of combined model separated by gender (left). Stripchart of combined model results by gender (right). 
