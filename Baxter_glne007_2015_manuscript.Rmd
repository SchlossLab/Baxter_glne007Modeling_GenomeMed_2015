...
_???_  
We characterized the bacterial communities of stool samples from 490 patients using 16S rRNA gene sequencing.  Among these patients, 120 had CRC, 109 had advanced adenomas, 89 had non-advanced adenomas, and 172 had no colonic lesions. First we tested whether a random forest model could distinguish healthy individuals from those with CRC. We determined the optimal model using the AUC-RF algorithm for maximizing the area under the curve (AUC) of the receiver operating characteristic (ROC) curve for the MMT [@calle2011auc]. The optimal model utilized XX bacterial populations, or operational taxonomic units (OTUs). 

- species in the model
- AUC, comparison to previous publications
- lesion vs normal
