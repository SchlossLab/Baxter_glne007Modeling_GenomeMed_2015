...
par(mar=c(4.5,4.5,1,1))
pdf('results/figures/supp_maleFemale.pdf', height=6, width=9)
...
gender <- 'Extended Data Fig. 3'
OTUs <- 'Extended Data Fig. 4'
