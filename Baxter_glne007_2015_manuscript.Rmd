...
abline(v=100, lty=3)
legend('bottomleft', legend=c('Detected by both tests', 'Detected by one test', 'Undetected', 'Test cutoff'), pch=c(21,21,21,NA), lty=c(NA,NA,NA,3), pt.bg=c('black','grey60','grey90',NA), cex=0.8)
