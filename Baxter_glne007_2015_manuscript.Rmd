...
plot(1, type="n", xlim=c(0.5,3.5), ylim=c(0.2,1), ylab="", xlab="", xaxt="n")
...
**Figure 3.** Scatter plot of the results of the combined model and FIT for each sample. Dashed lines show the cutoff for each test. 

###Extended Data Figures
![](results/tables/Schloss_EDtable1.png)  
**Extended Data Table 1.** Positive and negative predictive values for the combined model and FIT based on published estimates of CRC prevalence.
