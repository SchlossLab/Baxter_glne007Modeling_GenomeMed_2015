...
pdf('results/figures/Schloss_EDfig1.pdf', height=5, width=5)
...
pdf(file='results/figures/fig1A_ROCcurve.pdf', height=6, width=6)
...
pdf(file='results/figures/fig1B_stripCharts.pdf', height=5.5, width=6)
...
pdf('results/figures/Schloss_EDfig2.pdf', width=7, height=12)
...
pdf(file='results/figures/Schloss_EDfig3.pdf', height=7, width=7)
...
pdf('results/figures/Schloss_fig3.pdf', width=7, height=6)
...
pdf('results/figures/Schloss_fig2.pdf', height=6, width=9)
par(mar=c(4,4,2,2))
...
#render('results/tables/supp_table2.md', output_format='pdf_document', output_file='Schloss_EDtable2.pdf')
...
pdf('results/figures/Schloss_EDfig4.pdf', height=6, width=9)
