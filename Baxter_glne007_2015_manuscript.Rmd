...
png('results/figures/Schloss_EDfig2.png', width=7, height=12, units='in', res=150)
...
**Extended Data Figure 1.** Change in out-of-bag AUC with number of features in the random forest model. The optimal model contains 24 features and has an AUC of 0.8292.
