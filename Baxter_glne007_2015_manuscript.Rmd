...
rownames(sens_matrix) <- c('MMT','FIT')
...
legend('topleft', legend=c('MMT','FIT (100ng/ml cutoff)'), col=c('grey25','grey90'), pch=15, bty='n', pt.cex=2)
...
_**Fecal Immunochemical Tests.**_ Fecal material for FIT was collected from frozen stool aliquots using OC FIT-CHEK sampling bottles (Polymedco Inc.) and processed using an OC-Auto Micro 80 automated system (Polymedco Inc.). Raw FIT results were used for generating ROC curves and for building the MMT.
...
**Table 1.** Table of sensitivities and specificities for the MMT and FIT. The 95% confidence intervals were computed with 2000 stratified bootstrap replicates.
...
**Figure 2.** Barplot of sensitivities for the MMT and FIT for each stage of tumor development.  P-values based on McNemar's chi-squared test.

![](results/figures/Schloss_fig3.png)  
**Figure 3.** Scatter plot of the results of the MMT and FIT for each sample. Dashed lines show the cutoff for each test. Points with a FIT result of 0 are jittered to improve visibility.

###Extended Data Figures
![](results/tables/Schloss_EDtable1.png)  
**Extended Data Table 1.** Positive and negative posttest probabilities  for the MMT and FIT based on published estimates of CRC prevalence.
...
**Extended Data Figure 2.** Stripchart of the relative abundances of each OTU in the MMT with black lines at the means.
