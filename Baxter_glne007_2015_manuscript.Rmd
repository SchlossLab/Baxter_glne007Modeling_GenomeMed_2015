...
pdf(file='results/figures/figS4.pdf', height=7, width=7)
...
plot(1, type="n", xlim=c(0.1,10000), ylim=c(0.2,1), log='x',ylab="MMT Probability of Lesion", xlab="FIT (ng/ml)", xaxt='n')
...
pdf('results/figures/figS5.pdf', height=6, width=9)
...
![](results/tables/Schloss_table1.pdf)  
...
**Supplementary Figure 4.**  MMT Probabilities based on FIT results. Stripchart of MMT results for samples with a positive or negative FIT result.

![](results/figures/figS5.pdf)  
**Supplementary Figure 5.** Effect of sex on MMT performance. ROC curves (left) and stripchart (right) of MMT results separated by sex. 

![](results/tables/Schloss_tableS1.pdf)  
