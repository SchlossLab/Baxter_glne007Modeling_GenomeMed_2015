...
png('results/figures/Schloss_EDfig1.png', height=5, width=5, units='in', res=150)
plot(les_model, main='AUC-RF Model: Microbiota + FIT')
dev.off()
...
**Table 1**
Table of sensitivities and specificities for the RF model and FIT. The 95% confidence intervals were computed with 2000 stratified bootstrap replicates

![](results/figures/Schloss_fig2.png)  
**Figure 2**
Barplot of sensitivities for the RF model and FIT for each stage of tumor development.  P-values based on McNemar's chi-squared test.

![](results/figures/Schloss_fig3.png)  
**Figure 3**
Scatter plot of the results of the RF model and FIT for each sample. Dashed lines show the cutoff for each test. 
