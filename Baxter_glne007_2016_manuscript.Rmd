...
fp_mmt <- norm_pop*mmt_spec
fp_fit <-norm_pop*fit_spec_ci[2]

truePos_table <- matrix(c('Cancer','Advanced Adenoma','Non-advanced Adenoma','0.03%', '5.7%', '17.7%', canc_pop, advAde_pop, nonAdv_pop, canc_tp_mmt, advAde_tp_mmt, nonAdv_tp_mmt, canc_tp_fit, advAde_tp_fit, nonAdv_tp_fit), nrow=3)
