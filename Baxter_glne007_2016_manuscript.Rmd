...
legend(0,1, legend=c(sprintf('FIT (at %.1f%% specificity)',low_fit_spec*100),sprintf('MMT (at %.1f%% specificity)',mmt_spec*100)), col=c('grey90','grey25'), pch=15, bty='n', pt.cex=2)
