...
nonAdv_probs <- all_probs[all.data$Dx_Bin=='Adenoma',2]
...
nonAdv_fit <- all.data[all.data$Dx_Bin=='Adenoma','fit_result']
...
nonAdv_fit_sens <- length(nonAdv_fit[adenoma_fit>=100]) / length(nonAdv_fit)
...
advAde_pv <- getPV(advAde_sens,mod_spec_ci[2],0.057)
nonAdv_pv <- getPV(nonAdv_sens,mod_spec_ci[2],0.177)
canc_pv <- getPV(canc_sens_ci[2],mod_spec_ci[2],0.003)
les_pv<- getPV(les_sens_ci[2],mod_spec_ci[2],0.302)

advAde_fit_pv <- getPV(advAde_fit_sens,fit_spec_ci[2],0.057)
nonAdv_fit_pv <- getPV(nonAdv_fit_sens,fit_spec_ci[2],0.177)
